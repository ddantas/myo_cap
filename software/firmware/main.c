...
void timer0AInterrupt(void)
{
    ...
    //timer0 = TimerValueGet(TIMER0_BASE, TIMER_A);
    //timer1 = TimerValueGet(TIMER1_BASE, TIMER_A);
    ...
    if(acquition_mode == FUNC_GEN_ACQUISITION){
        ...
        //print_uint32 (0x0000);
        //print_uint32 (timestamp);
        adc_values[0] = function_gen(Square_Wave, timestamp);
        //UARTCharPut(UART0_BASE, adc_values[0]);
        //UARTCharPut(UART0_BASE, adc_values[0]);
    }
...
void main(void)
{
    ...
    timer1[0] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[1] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[2] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[3] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[4] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[5] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[6] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[7] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[8] = TimerValueGet(TIMER0_BASE, TIMER_A);
    timer1[9] = TimerValueGet(TIMER0_BASE, TIMER_A);
