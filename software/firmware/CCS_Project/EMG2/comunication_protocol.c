...
void command_handler(comunication_packet *pkt_received, tiva_status *tiva_actual_state){
    ...
    switch(pkt_received->uint32_param_pkt.command){                                // Checks the command in the received packet
        ...
        case SET_SAMPLE_RATE           :                                                                                 break;

        case SET_NUMBER_CHANNELS       :                                                                                 break;

        case SET_NUMBER_BOARDS         :                                                                                 break;

        case SET_NUMBER_BYTES_IN_PACKET:                                                                                 break;

        case SET_BITS_PER_SAMPLE       :                                                                                 break;
        ...
        case GET_SAMPLE_RATE           :                                                                                 break;

        case GET_NUMBER_CHANNELS       :                                                                                 break;

        case GET_NUMBER_BOARDS         :                                                                                 break;

        case GET_NUMBER_BYTES_IN_PACKET:                                                                                 break;

        case GET_BITS_PER_SAMPLE       :                                                                                 break;
        ...
        case SET_FUNC_GEN_FREQUENCE    :       {tiva_actual_state->func_gen_frequence  =  pkt_received->uint32_param_pkt.uint32_operand ;
        ...
        case GET_FUNC_GEN_WAVE_FORM    :                                                                                                            break;
