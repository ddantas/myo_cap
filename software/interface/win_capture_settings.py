...
class Ui_CaptureSettingsWindow(object):
    def setupUi(self, CaptureSettingsWindow):
        ...
        CaptureSettingsWindow.resize(381, 340)
        ...
        self.input_ampS.setGeometry(QtCore.QRect(200, 230, 71, 31))
    ...
    def retranslateUi(self, CaptureSettingsWindow):
        ...
        self.input_ampS.setText(_translate("CaptureSettingsWindow", "0", None))
        self.label_12.setText(_translate("CaptureSettingsWindow", "Bits per sample:", None))
        self.label_14.setText(_translate("CaptureSettingsWindow", "Amplitude:", None))
        self.input_ampE.setInputMask(_translate("CaptureSettingsWindow", "4; ", None))
