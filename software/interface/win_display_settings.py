...
class Ui_DisplaySettingsWindow(object):
    def setupUi(self, DisplaySettingsWindow):
        ...
        self.input_htick.setEnabled(False)
        ...
        self.input_vtick.setEnabled(False)
